...
#define I2S_BCK_IO              BOARD_I2S_BCK_IO
#define I2S_WS_IO               BOARD_I2S_WS_IO
#define I2S_DO_IO               BOARD_I2S_DO_IO
#define I2S_DI_IO               BOARD_I2S_DI_IO
#define I2S_MCK_IO              BOARD_I2S_MCK_IO
